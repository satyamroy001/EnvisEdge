package com.nimbleedge.recoedge.identifiers
...
//case class ParentIdentifier extends Identifier {
...
//
//  // Hash digest
//  override def computeDigest(): Array[Byte] = hash("_Parent" + id, List.empty)
//}
